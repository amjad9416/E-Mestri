...
public class b1 extends Activity 
{
    ...
    {
		TextView q1,q2,q3,q4,r11,r1,r2,r3,r4,tt1,t2,t3,t4,t11,t19,t16;
        ...
        setContentView(R.layout.activityb1);
...
//		qu1010= Float.parseFloat(t10.getText().toString());
	...
	////	qu1414= Float.parseFloat(t14.getText().toString());
		...
		Float total=qu11+qu22+qu33+qu44+qu1111;
